...
class NearEarthObject:
    ...
    def __str__(self):
        """Return `str(self)`."""
        #this object's attributes returns a readable string representation. Look at the __repr__
        # method for examples of advanced formatting.
...
class CloseApproach:
    ...
    def __init__(self, designation='', time='', distance=float('nan'), velocity=float('nan'),neo= None):
        ...
        #Info from the arguments passed to the constructoronto attributes.
        # These values to match data types.
    ...
    def fullname(self):    
        """
        Return a formatted representation of this `CloseApproachs' full name."""
        #if self.neo:
        return f"{self.designation} ({self.neo.name or 'N/A'})"
            
    def serialize(self):
        """Returns a dict representation of self attributes."""
    ...
    def time_str(self):
        ...
        object's `.time` attribute and the `datetime_to_str` function to
        object's `.time` attribute and the `datetime_to_str` function to build a formatted representation of approach time.
    ...
    def __str__(self):
        """Return `str(self)`."""
        """object's attributes to return a readable string representation.
        The __repr__ method for examples of advanced string formatting."""
